...
class Contact(Base):
    def __init__(self, name, mail="", linked_host_notifications=None, linked_host_notification_period=None,
                 linked_metric_notifications=None, linked_metric_notification_period=None, variables=None):
